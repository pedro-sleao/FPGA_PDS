...
module soc_system_mm_interconnect_0_mm_interconnect_0 (
	...
	) avmm_to_wishbone_bridge_avmm_agent_m0_translator (
		.clk                    (clk_0_clk_clock_bridge_out_clk_clk),                                                       //                       clk.clk
		.reset                  (avmm_to_wishbone_bridge_avmm_agent_clk_reset_reset_bridge_in_reset_reset),                 //                     reset.reset
		.uav_address            (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (avmm_to_wishbone_bridge_avmm_agent_m0_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (avmm_to_wishbone_bridge_avmm_agent_m0_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (avmm_to_wishbone_bridge_avmm_agent_m0_burstcount),                                         //                          .burstcount
		.av_byteenable          (avmm_to_wishbone_bridge_avmm_agent_m0_byteenable),                                         //                          .byteenable
		.av_read                (avmm_to_wishbone_bridge_avmm_agent_m0_read),                                               //                          .read
		.av_readdata            (avmm_to_wishbone_bridge_avmm_agent_m0_readdata),                                           //                          .readdata
		.av_readdatavalid       (avmm_to_wishbone_bridge_avmm_agent_m0_readdatavalid),                                      //                          .readdatavalid
		.av_write               (avmm_to_wishbone_bridge_avmm_agent_m0_write),                                              //                          .write
		.av_writedata           (avmm_to_wishbone_bridge_avmm_agent_m0_writedata),                                          //                          .writedata
		.av_lock                (avmm_to_wishbone_bridge_avmm_agent_m0_lock),                                               //                          .lock
		.av_debugaccess         (avmm_to_wishbone_bridge_avmm_agent_m0_debugaccess),                                        //                          .debugaccess
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clock_bridge_out_clk_clk),                                                                            //                      clk.clk
		.reset                  (avmm_to_wishbone_bridge_avmm_agent_clk_reset_reset_bridge_in_reset_reset),                                      //                    reset.reset
		.uav_address            (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_address),                            // avalon_universal_slave_0.address
		.uav_burstcount         (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_burstcount),                         //                         .burstcount
		.uav_read               (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_read),                               //                         .read
		.uav_write              (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_write),                              //                         .write
		.uav_waitrequest        (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_waitrequest),                        //                         .waitrequest
		...
		.uav_lock               (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_lock),                               //                         .lock
		.uav_debugaccess        (avmm_to_wishbone_bridge_avmm_agent_m0_translator_avalon_universal_master_0_debugaccess),                        //                         .debugaccess
		.av_address             (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_address),       //      avalon_anti_slave_0.address
		.av_write               (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_write),         //                         .write
		.av_read                (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_read),          //                         .read
		.av_readdata            (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_readdata),      //                         .readdata
		.av_writedata           (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_writedata),     //                         .writedata
		.av_burstcount          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_burstcount),    //                         .burstcount
		.av_byteenable          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_byteenable),    //                         .byteenable
		.av_readdatavalid       (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_readdatavalid), //                         .readdatavalid
		.av_waitrequest         (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_waitrequest),   //                         .waitrequest
		.av_lock                (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_lock),          //                         .lock
		.av_debugaccess         (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_debugaccess),   //                         .debugaccess
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clock_bridge_out_clk_clk),                                                                                     //       clk.clk
		.reset                 (avmm_to_wishbone_bridge_avmm_agent_clk_reset_reset_bridge_in_reset_reset),                                               // clk_reset.reset
		.av_address            (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_address),                //        av.address
		.av_write              (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_write),                  //          .write
		.av_read               (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_read),                   //          .read
		.av_writedata          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_writedata),              //          .writedata
		.av_readdata           (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_readdata),               //          .readdata
		...
		.av_debugaccess        (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_debugaccess),            //          .debugaccess
		.av_lock               (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_lock),                   //          .lock
		.cp_valid              (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_agent_cp_valid),         //        cp.valid
		.cp_data               (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_agent_cp_data),          //          .data
		.cp_startofpacket      (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_agent_cp_startofpacket), //          .startofpacket
		.cp_endofpacket        (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_agent_cp_endofpacket),   //          .endofpacket
		.cp_ready              (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_agent_cp_ready),         //          .ready
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent (
		.clk                     (clk_0_clk_clock_bridge_out_clk_clk),                                                                //             clk.clk
		.reset                   (avmm_to_wishbone_bridge_avmm_agent_clk_reset_reset_bridge_in_reset_reset),                          //       clk_reset.reset
		.m0_address              (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_address),                          //              m0.address
		.m0_burstcount           (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_burstcount),                       //                .burstcount
		.m0_byteenable           (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_byteenable),                       //                .byteenable
		.m0_debugaccess          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_debugaccess),                      //                .debugaccess
		.m0_lock                 (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_lock),                             //                .lock
		.m0_readdata             (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_readdata),                         //                .readdata
		.m0_readdatavalid        (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_readdatavalid),                    //                .readdatavalid
		.m0_read                 (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_read),                             //                .read
		.m0_waitrequest          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_waitrequest),                      //                .waitrequest
		.m0_writedata            (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_writedata),                        //                .writedata
		.m0_write                (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_write),                            //                .write
		.rp_endofpacket          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rp_ready),                   //                .ready
		.rp_valid                (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rp_valid),                   //                .valid
		.rp_data                 (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rp_data),                    //                .data
		.rp_startofpacket        (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                                                                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                                                                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                                                                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                                                                     //                .error
		.rdata_fifo_src_ready    (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rdata_fifo_src_data),        //                .data
	...
	) avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo (
		.clk               (clk_0_clk_clock_bridge_out_clk_clk),                                                                //       clk.clk
		.reset             (avmm_to_wishbone_bridge_avmm_agent_clk_reset_reset_bridge_in_reset_reset),                          // clk_reset.reset
		.in_data           (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rf_source_data),             //        in.data
		.in_valid          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rf_source_valid),            //          .valid
		.in_ready          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	soc_system_mm_interconnect_0_mm_interconnect_0_router router (
		.sink_ready         (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_agent_cp_ready),         //      sink.ready
		.sink_valid         (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_agent_cp_valid),         //          .valid
		.sink_data          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_agent_cp_data),          //          .data
		.sink_startofpacket (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_translator_avalon_anti_slave_0_agent_cp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clock_bridge_out_clk_clk),                                                                                     //       clk.clk
		.reset              (avmm_to_wishbone_bridge_avmm_agent_clk_reset_reset_bridge_in_reset_reset),                                               // clk_reset.reset
	...
	soc_system_mm_interconnect_0_mm_interconnect_0_router_001 router_001 (
		.sink_ready         (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rp_ready),         //      sink.ready
		.sink_valid         (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rp_valid),         //          .valid
		.sink_data          (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rp_data),          //          .data
		.sink_startofpacket (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clock_bridge_out_clk_clk),                                                      //       clk.clk
		.reset              (avmm_to_wishbone_bridge_avmm_agent_clk_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (avmm_to_wishbone_bridge_avmm_agent_clk_reset_reset_bridge_in_reset_reset),                    // in_rst_0.reset
		.in_0_data      (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (avmm_to_wishbone_bridge_avmm_translator_avalon_universal_slave_0_agent_rdata_fifo_src_ready), //         .ready
