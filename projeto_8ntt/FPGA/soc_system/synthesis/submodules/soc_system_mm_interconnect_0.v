...
module soc_system_mm_interconnect_0 (
	...
	wire   [94:0] avmm_to_wishbone_bridge_avmm_agent_rf_source_data;                // avmm_to_wishbone_bridge_avmm_agent:rf_source_data -> avmm_to_wishbone_bridge_avmm_agent_rsp_fifo:in_data
	...
	wire   [94:0] avmm_to_wishbone_bridge_avmm_agent_rsp_fifo_out_data;             // avmm_to_wishbone_bridge_avmm_agent_rsp_fifo:out_data -> avmm_to_wishbone_bridge_avmm_agent:rf_sink_data
	...
	wire   [93:0] avmm_to_wishbone_bridge_avmm_agent_rp_data;                       // avmm_to_wishbone_bridge_avmm_agent:rp_data -> router_002:sink_data
	...
	wire   [93:0] avmm_to_wishbone_bridge_avmm_burst_adapter_source0_data;          // avmm_to_wishbone_bridge_avmm_burst_adapter:source0_data -> avmm_to_wishbone_bridge_avmm_agent:cp_data
	...
	wire    [1:0] avmm_to_wishbone_bridge_avmm_burst_adapter_source0_channel;       // avmm_to_wishbone_bridge_avmm_burst_adapter:source0_channel -> avmm_to_wishbone_bridge_avmm_agent:cp_channel
	...
	wire   [93:0] router_002_src_data;                                              // router_002:src_data -> avmm_to_wishbone_bridge_avmm_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                             // avmm_to_wishbone_bridge_avmm_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                           // router_002:src_channel -> avmm_to_wishbone_bridge_avmm_rsp_width_adapter:in_channel
	...
	wire  [111:0] avmm_to_wishbone_bridge_avmm_rsp_width_adapter_src_data;          // avmm_to_wishbone_bridge_avmm_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [1:0] avmm_to_wishbone_bridge_avmm_rsp_width_adapter_src_channel;       // avmm_to_wishbone_bridge_avmm_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [111:0] cmd_mux_src_data;                                                 // cmd_mux:src_data -> avmm_to_wishbone_bridge_avmm_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                // avmm_to_wishbone_bridge_avmm_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                              // cmd_mux:src_channel -> avmm_to_wishbone_bridge_avmm_cmd_width_adapter:in_channel
	...
	wire   [93:0] avmm_to_wishbone_bridge_avmm_cmd_width_adapter_src_data;          // avmm_to_wishbone_bridge_avmm_cmd_width_adapter:out_data -> avmm_to_wishbone_bridge_avmm_burst_adapter:sink0_data
	...
	wire    [1:0] avmm_to_wishbone_bridge_avmm_cmd_width_adapter_src_channel;       // avmm_to_wishbone_bridge_avmm_cmd_width_adapter:out_channel -> avmm_to_wishbone_bridge_avmm_burst_adapter:sink0_channel
